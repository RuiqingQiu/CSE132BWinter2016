	...
	<h2>Instructor Form</h2>
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Instructor WHERE SectionID = ? and FacultyName = ?");
                    ...
                    <tr>
                        <form action="instructor.jsp" method="get">
			            	...
			            	<%
								...
								if (!rs_department.isBeforeFirst() ) {    
							%>
								<option value="no classes" name="SectionID" > There are no classes </option>
							<% 
							}
							else{
							%>
                        ...
                        <form action="instructor.jsp" method="get">
                            ...
                            <td>
            					...
            					<%
                        			...
                        			rs_department = department_Statement.executeQuery("SELECT * FROM Classes");
