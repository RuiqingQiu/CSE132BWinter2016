...
<h3>Minor Entry Form</h3>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
						...
						pstmt.setString(1, request.getParameter("MinorName"));
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Minor WHERE MinorName = ?");

                        pstmt.setString(
                            1, request.getParameter("MinorName"));
                        int rowCount = pstmt.executeUpdate();
                ...
                <table border="1" class="table table-bordered">
                    ...
                    <tr>
                        <form action="minor.jsp" method="get">
                            ...
                            <th><input value="" name="MinorName" size="10"></th>                            
            ...
            %>
                    ...
                    <tr>
                        <form action="minor.jsp" method="get">
                            ...
                            <%-- Get the Name --%>
                            <td>
                                <input value="<%= rs.getString("MinorName") %>" 
                                    name="MinorName" size="10">
                            </td>
                        </form>
                        <form action="minor.jsp" method="get">
                            <input type="hidden" value="delete" name="action">
                            <input type="hidden" 
                                value="<%= rs.getString("MinorName") %>" name="MinorName">
                            <%-- Button --%>
                            <td>
